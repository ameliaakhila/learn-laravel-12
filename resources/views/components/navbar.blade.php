<nav class="bg-gray-800/50">
    <div class="mx-20 max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <a href="https://laravel.com/docs/12.x">
                        <img src="{{asset('img/Laravel.svg')}}" alt="Your Company" class="size-8 mx-2" />
                    </a>
                </div>
                <p class="text-white text-sm sm:text-xl font-semibold sm:text-center">Learn <span
                        class="text-red-500">Laravel 12</span></p>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        <button
                            ...
                            <img src="{{asset('img/amel.JPG')}}" alt=""
